...
if __name__ == "__main__":
    run_braess_analysis(
        ...
        output_dir=r"C:\Users\OMEN\Desktop\brasses_results\koramangala",  # <-- where results go
    ...
    #     dist_m=1500,
    #     use_synthetic=False,
    #     output_dir=r"C:\Users\OMEN\Desktop\brasses_results\whitefield",
    #     total_demand=8000,
    #     motif_demand=0,
    # )
    ...
    #     dist_m=1500,
    #     use_synthetic=False,
    #     output_dir=r"C:\Users\OMEN\Desktop\brasses_results\lajpat_nagar",
    #     total_demand=8000,
    #     motif_demand=0,
    # )
    ...
    #     output_dir=r"C:\Users\OMEN\Desktop\brasses_results\synthetic_test",
    #     total_demand=14000,
    #     motif_demand=1000,
    # )
